...
public class MobDisplayActivity extends ArrayAdapter<Player> implements View.OnClickListener {
    ...
    private final MobDisplayActivity.OnClickPlayerListener mListener;
    ...
    MobDisplayActivity(@NonNull Context context, int resource, MobDisplayActivity.OnClickPlayerListener listener) {
    ...
    View getView(int position, @Nullable View convertView,
       ...
       MobDisplayActivity.ViewHolder holder;
        if (convertView == null) {
            convertView = mInflater.inflate(R.layout.players_example_item, parent, false);
            holder = new MobDisplayActivity.ViewHolder();
    ...
    public void onClick(View v) {
        Log.d(TAG, "onClick");
        if (mListener != null) {
            MobDisplayActivity.ViewHolder holder = (MobDisplayActivity.ViewHolder) v.getTag();
